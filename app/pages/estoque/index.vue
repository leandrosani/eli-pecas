  ...
  <div class="pb-20 relative">
    ...
    <div class="md:hidden space-y-2.5">
      ...
      >
        ...
        <!-- Endereço -->
        <div v-if="item.detalhes" class="mt-7 mb-2 p-2 bg-gradient-to-br from-orange-50 to-orange-100/80 rounded-md border border-orange-200">
          <div class="flex justify-between items-center">
        ...
        <div class="mt-5 flex gap-6 justify-between">
          <!-- Botão Vender -->
          <UButton
